...
class Semester3st extends StatefulWidget {
  const Semester3st({Key key}) : super(key: key);

  @override
  _Semester3stState createState() => _Semester3stState();
}

class _Semester3stState extends State<Semester3st> {
  var subjectNames = <String, Map<String, String>>{
    'subject0': {
      'subjectCode': 'BCA320C1',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Syllbus Semester III'),
        ),
        body: ListView(
          children: [
            Padding(
                    ...
                    Padding(
                      ...
                      child: GFButton(
                        ...
                        onPressed: () {
                          openFile(
                              url:
                                  'https://egov.uok.edu.in/courseinfo/syllabus/syllabusArchive/8198.PDF',
                              fileName:
                    ...
                    Padding(
                      ...
                      child: GFButton(
                        ...
                        onPressed: () {
                          openFile(
                              url:
                                  'https://egov.uok.edu.in/courseinfo/syllabus/syllabusArchive/8199.PDF',
                              fileName:
                    ...
                    Padding(
                      ...
                      child: GFButton(
                        ...
                        onPressed: () {
                          openFile(
                              url:
                                  'https://egov.uok.edu.in/courseinfo/syllabus/syllabusArchive/8200.PDF',
                              fileName:
